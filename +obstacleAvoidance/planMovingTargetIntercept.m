...
% remain nested in PlannerOptions and are normalized by planTrajectory.
defaults = struct( ...
...
if isfield(plannerOptions, "PlannerMethod") && ~isempty(plannerOptions.PlannerMethod)
    selectedDefaults = obstacleAvoidance.planTrajectory(plannerOptions.PlannerMethod);
...
plannerDefaults = obstacleAvoidance.planTrajectory(plannerMethod);
