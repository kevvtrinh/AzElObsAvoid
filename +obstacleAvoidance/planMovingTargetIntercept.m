...
if options.InterceptMode == "specifiedTime"
    ...
    [result, diagnosis] = planAtTime(obstacles, initialState, targetMotion, ...
        limits, options, interceptTime_s, nargout > 1);
    search = searchRecord("specifiedFixedTime", 1, 0, 0, ...
        interceptTime_s, interceptTime_s, interceptTime_s, interceptTime_s, 0, struct());
else
...
function [result, diagnosis] = planAtTime( ...
