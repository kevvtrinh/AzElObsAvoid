...
%       EnableStagnationStop is a scalar logical control for the optional
%       BMTP retained-best stagnation stop. Default is false.
%       StagnationIterationLimit is a positive integer collision-free trial
%       count. Default is 5. StagnationImprovementTolerance_s is positive
%       and defaults to ArrivalTimeTolerance_s when not overridden.
...
%       is unchanged. Default is false. PlaneReuseImprovementTolerance_s is
...
defaults = struct( ...
    ...
    "EnableStagnationStop", false, "StagnationIterationLimit", 5, ...
    "StagnationImprovementTolerance_s", 1e-3, ...
    "EnablePlaneReuse", false, "PlaneReuseImprovementTolerance_s", 1e-3, ...
...
if ~isfield(optionOverrides, "StagnationImprovementTolerance_s") || ...
        isempty(optionOverrides.StagnationImprovementTolerance_s)
    options.StagnationImprovementTolerance_s = options.ArrivalTimeTolerance_s;
end
...
for fieldName = ["AllowAzimuthWrapping", "Verbose", "EnableStagnationStop", ...
        "EnablePlaneReuse"]
...
for fieldName = ["ArrivalTimeTolerance_s", "ConstraintTolerance", ...
        "StagnationImprovementTolerance_s", ...
