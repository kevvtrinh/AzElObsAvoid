...
for orderIndex = 1:numel(seedOrder)
    ...
    if useWaypointHybrid
        passThroughSearch = ...
            ...
            "classifySearch", originalSeed.position_deg, ...
            options.ConstraintTolerance);
    end
    ...
    while true
        ...
        if finalCandidate.Validation.Passed
            ...
            if canRefineActivityMesh
                ...
                activityMesh = ...
                    obstacleAvoidance.planner.ruckigWarmStart( ...
                    "createActivityMesh", finalCandidate, ...
                    directTimingProfile, limits, ...
...
profile = obstacleAvoidance.planner.ruckigWarmStart( ...
    "solveSeedCandidate", initialState, goalState, limits, options, ...
    seed, sweepCount);
