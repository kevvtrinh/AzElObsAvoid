...
diagnostics = struct( ...
    ...
    zeros(max(0, partCount - 1), 2), ...
    "InteriorWaypointAcceleration_deg_s2", ...
    zeros(max(0, partCount - 1), 2), ...
    "AllInteriorWaypointsConstrainedToRest", true, ...
    "ElapsedTime_s", 0);
if partCount > maximumSupportedPartCount
    diagnostics.EngineTerminationReason = ...
        "ruckigWaypointSegmentLimitExceeded";
    diagnostics.ElapsedTime_s = toc(solveTimer);
    candidate.Message = ...
        "Ruckig waypoint composition supports at most " + ...
        maximumSupportedPartCount + " route segments; the normalized " + ...
        "route contains " + partCount + ".";
