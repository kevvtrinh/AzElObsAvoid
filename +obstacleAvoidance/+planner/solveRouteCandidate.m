...
seedCorridor = obstacleAvoidance.search.createSeedCorridor(seed, segmentCount);
...
if isEarliestArrival
    ...
    stageOneObjective = @(decision) ...
        hs3Internal.polynomial.evaluateIntegratedSquaredJerk(decision, false, latestFinalTime_s, ...
...
if ~isEarliestArrival
    [~, ~, problem.Hessian] = hs3Internal.polynomial.evaluateIntegratedSquaredJerk( ...
        decision0, false, latestFinalTime_s, segmentCount, startTime_s, 2);
end
core = hs3Internal.solver.optimize(problem, coreOptions);
...
basePolynomial = createPlannerPolynomial(zeroJerk_deg_s3, initialState, finalTime_s, segmentCount);
...
enginePolynomial = hs3Internal.polynomial.createTrajectoryPolynomial( ...
