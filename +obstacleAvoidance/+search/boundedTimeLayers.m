function [layerTimes_s, layerLimitApplied, candidateLayerCount] = ...
        boundedTimeLayers( ...
...
%       obstacleAvoidance.search.boundedTimeLayers( ...
%       sampleTimes_s, startTime_s, endTime_s, maximumLayerCount)
%**************************************************************************
% PURPOSE
...
%   - maximumLayerCount (integer scalar at least two)
%       Maximum retained layer count, including both endpoints.
%**************************************************************************
% OUTPUTS
%   - layerTimes_s (numeric column vector)
%       Sorted retained times including both interval endpoints.
%   - layerLimitApplied (logical scalar)
%       True when the candidate time-layer set exceeded the configured bound.
%   - candidateLayerCount (positive integer scalar)
%       Count before applying the bound.
%**************************************************************************
% UNITS
...
candidateLayerCount = numel(candidateTime_s);
layerLimitApplied = candidateLayerCount > maximumLayerCount;
if ~layerLimitApplied
