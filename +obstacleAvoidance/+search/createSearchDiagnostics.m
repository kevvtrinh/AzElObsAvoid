...
if routeSet.TimedSearchAttempted
    ...
    if isfield(timedRecord, "GoalCostBoundRejectionCount")
        diagnostics.GoalCostBoundRejectionCount = timedRecord.GoalCostBoundRejectionCount;
    end
    if isfield(timedRecord, "CandidateBatchSplitCount")
        diagnostics.CandidateBatchSplitCount = timedRecord.CandidateBatchSplitCount;
    end
...
function diagnostics = emptyDiagnostics(start_units, goal_units)
    ...
    diagnostics = struct("GraphType", "notBuilt", ...
        ...
        "GoalCostBoundRejectionCount", 0, ...
        "CandidateBatchSplitCount", 0, ...
