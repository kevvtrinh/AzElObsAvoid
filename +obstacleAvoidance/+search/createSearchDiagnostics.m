...
diagnostics.Coverage.ReducedSpatialProposalUsed = ...
    proposal.usedDenseEnvelope;
diagnostics.Coverage.TimedSearchInitialDeferred = ...
    routeSet.TimedSearchDeferred;
diagnostics.Coverage.TimedSearchRecoveryAttempted = ...
    routeSet.TimedSearchRecoveryAttempted;
diagnostics.Coverage.MultiWindingRouteCount = ...
    numel(routeSet.DeferredSpatialRoutes_deg);
diagnostics.Coverage.MultiWindingSolveAttempted = ...
...
coverage = struct("ExactSpatialProposalUsed", false, ...
    ...
    "MultiWindingRouteCount", 0, ...
    "MultiWindingSolveAttempted", false, ...
