function [seeds, diagnostics] = createRouteCandidates(obstacles, initialState, goalState, limits, options)
...
[nodePosition_deg, edgeCost_deg, graphRecord] = createVisibilityGraph( ...
...
function [nodePosition_deg, edgeCost_deg, record] = createVisibilityGraph( ...
...
[edgeStart_deg, edgeEnd_deg] = obstacleAvoidance.geometry.boundaryToEdges(sweptShape, 1e-12);
...
if ~forceExhaustiveVisibility && exhaustiveVisibilityAffordable && ~endpointsConnected
    [nodePosition_deg, edgeCost_deg, record] = createVisibilityGraph( ...
...
sampleTimes_s = obstacleAvoidance.search.boundedTimeLayers( ...
...
[edgeStart_deg, edgeEnd_deg] = obstacleAvoidance.geometry.boundaryToEdges( ...
