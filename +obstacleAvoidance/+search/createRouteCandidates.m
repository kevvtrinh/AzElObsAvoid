...
diagnostics.CandidateOffsetRetryCount = ...
    graphRecord.CandidateOffsetRetryCount;
...
elseif hasChangingHistory
    ...
    diagnostics.TemporalRequestedMaximumLayerCount = ...
        timedRecord.RequestedMaximumLayerCount;
    diagnostics.TemporalEffectiveMaximumLayerCount = ...
        timedRecord.EffectiveMaximumLayerCount;
    diagnostics.TemporalMaximumStateCount = timedRecord.MaximumStateCount;
    diagnostics.TemporalMaximumTransitionCount = ...
        timedRecord.MaximumTransitionCount;
    diagnostics.TemporalEstimatedStateCount = timedRecord.EstimatedStateCount;
    diagnostics.TemporalEstimatedTransitionCount = ...
        timedRecord.EstimatedTransitionCount;
    diagnostics.TemporalStateLimitApplied = timedRecord.StateLimitApplied;
    diagnostics.TemporalTransitionLimitApplied = ...
        timedRecord.TransitionLimitApplied;
    diagnostics.TemporalWorkLimitExceeded = timedRecord.WorkLimitExceeded;
    diagnostics.TimedSearchTerminationReason = timedRecord.TerminationReason;
    ...
    if timedRecord.WorkLimitExceeded
        diagnostics.Coverage.TimedSearchSuppressionReason = ...
            "timedSearchWorkLimit";
    end
    diagnostics = appendSearchDiagnostics(diagnostics, timedRecord);
    seeds = appendTimedSeed( ...
        seeds, template, route_deg, routeTime_s, timedRecord);
end
...
diagnostics.RouteCleanupAttemptedCount = ...
    searchRecord.RouteCleanupAttemptedCount;
diagnostics.RouteCleanupCandidateCount = ...
    searchRecord.RouteCleanupCandidateCount;
diagnostics.RouteCleanupVisibilityRejectedCount = ...
    searchRecord.RouteCleanupVisibilityRejectedCount;
diagnostics.RouteCleanupHomologyRejectedCount = ...
    searchRecord.RouteCleanupHomologyRejectedCount;
diagnostics.RouteCleanupAcceptedCount = ...
    searchRecord.RouteCleanupAcceptedCount;
diagnostics.RouteCleanupLengthReduction_deg = ...
    searchRecord.RouteCleanupLengthReduction_deg;
...
seed.MaximumTimedSegmentCount = max( ...
    1, timedRecord.EffectiveMaximumLayerCount - 1);
...
diagnostics = struct("GraphType", "timeExpandedVisibilityGraph", ...
    ...
    "TemporalNodeCount", 0, "TemporalRequestedMaximumLayerCount", 0, ...
    "TemporalEffectiveMaximumLayerCount", 0, ...
    "TemporalMaximumStateCount", 0, ...
    "TemporalMaximumTransitionCount", 0, ...
    "TemporalEstimatedStateCount", 0, ...
    "TemporalEstimatedTransitionCount", 0, ...
    "TemporalStateLimitApplied", false, ...
    "TemporalTransitionLimitApplied", false, ...
    "TemporalWorkLimitExceeded", false, ...
    "TimedSearchTerminationReason", "notAttempted", ...
    "WaitEdgeCount", 0, "MotionEdgeCount", 0, ...
