...
% SYNTAX: time_s = obstacleAvoidance.search.createTimeLayers(obstacles, startTime_s, endTime_s)
% PURPOSE: Share the physical time grid between route search and timed motion solving.
% INPUTS: Canonical or prepared obstacles and the requested start/end times.
% OUTPUTS: Sorted unique source, midpoint, endpoint, and uniform request times.
% UNITS: Seconds.
