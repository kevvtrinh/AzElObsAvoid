function containsAllObstacles = seedEnvelopeContainsObstacles( ...
        boundary_deg, obstacles, tolerance_deg, startTime_s, endTime_s)
...
%       Closed trajectory horizon whose complete geometry must be contained.
%**************************************************************************
% OUTPUTS
...
%% Section 2: Verify Source-Derived Horizon Sweeps
...
for obstacleIndex = 1:numel(obstacles)
    ...
    sweptShape = horizonGeometry.SweepShape;
