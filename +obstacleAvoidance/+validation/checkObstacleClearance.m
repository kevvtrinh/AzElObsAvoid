...
if ~planeCertificateCertified
    [planeCertificateCertified, planeClearance_deg, certificateRejectionReason] = ...
...
function [certified, minimumClearance_deg, rejectionReason] = ...
        checkMovingObstacleClearance(trajectory, obstacles, options)
...
[regionCoveragePassed, rejectionReason] = timedRegionCoverageMatches( ...
