...
if isfield(obstacles, "InternalPreparation")
    ...
    for obstacleIndex = 1:numel(obstacles)
        ...
        hasCurrentSchema = isstruct(preparation) && ...
            ...
            preparation.PreparationVersion == preparationVersion && ...
...
for obstacleIndex = 1:numel(obstacles)
    ...
    for intervalIndex = 1:intervalCount
        ...
        intervalVertices_deg = [lowerAzimuth_deg, lowerElevation_deg; ...
            alignedOrOriginalUpper( ...
            matchingTopology(intervalIndex), alignedUpper_deg, ...
            upperAzimuth_deg, upperElevation_deg)];
...
% Retain an exact immutable copy of every canonical source field.
snapshot = struct( ...
...
function upper_deg = alignedOrOriginalUpper( ...
        usesAlignment, alignedUpper_deg, upperAzimuth_deg, ...
        upperElevation_deg)
% Use verified correspondence for interval bounds without changing geometry.
if usesAlignment
    upper_deg = alignedUpper_deg;
else
