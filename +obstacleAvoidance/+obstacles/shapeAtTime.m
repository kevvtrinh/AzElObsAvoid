...
% SYNTAX: [shape, geometry] = obstacleAvoidance.obstacles.shapeAtTime( obstacle, queryTime_s)
...
%   and source-slice metadata. status is metadata and never deactivates supplied geometry.
% UNITS: Geometry is coordinate units; time is seconds; speed is coordinate units per second. See
%   obstacle_history_contract.md for the complete history model.
