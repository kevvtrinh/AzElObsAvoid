...
validation.PolynomialInitialTimeMatched = ...
    polynomialChecks.InitialTimeMatched;
validation.PolynomialTimeBaseConsistent = ...
    polynomialChecks.TimeBaseConsistent;
validation.PolynomialSegmentContinuity = ...
    polynomialChecks.SegmentContinuity;
validation.PolynomialEndpointStatesMatched = ...
    polynomialChecks.EndpointStatesMatched;
validation.PolynomialHistoryConsistent = ...
    polynomialChecks.HistoryConsistent;
validation.MaximumSegmentContinuityResidual = ...
    polynomialChecks.MaximumSegmentContinuityResidual;
validation.MaximumPolynomialHistoryResidual = ...
...
validation.CollisionIntervalCount = collisionIntervalCount;
validation.UnresolvedIntervalCount = unresolvedIntervalCount;
validation.CollisionDiagnostics = collisionDiagnostics;
...
validation.PeakAcceleration_deg_s2 = ...
    maximumAbsolute(acceleration_deg_s2);
...
validation = struct( ...
    ...
    "DynamicsConsistent", false, ...
    "MaximumDynamicsResidual", NaN, ...
    "CollisionFree", false, ...
    "CollisionResolved", false, ...
    "SeedCorridorCertified", false, ...
    "PlaneCertificateCertified", false, ...
    "MinimumClearance_deg", NaN, ...
    "CollisionCheckCount", 0, ...
    "CollisionIntervalCount", 0, ...
