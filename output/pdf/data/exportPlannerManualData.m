...
[endpointFeasible, ~, endpointReason] = ...
    ...
    preparedObstacles, result.Inputs.initialState, result.Inputs.goalState, ...
    result.Inputs.limits, result.Options);
directAttempt = result.SearchDiagnostics.DirectAttempt;
fixedClock = result.SearchDiagnostics.FixedClockExcursion;
timedOpening = result.SearchDiagnostics.TimedOpening;
cavity = result.SearchDiagnostics.OrthogonalCavity;
grid = result.SearchDiagnostics.Grid;
...
fprintf(fileIdentifier, "\\newcommand{\\WalkDirectDuration}{%.12f s}\n", ...
    directAttempt.MotionDuration_s);
fprintf(fileIdentifier, "\\newcommand{\\WalkDirectLength}{%.12f deg}\n", ...
    directAttempt.MotionLength_deg);
fprintf(fileIdentifier, "\\newcommand{\\WalkDirectReason}{%s}\n", ...
    directAttempt.TerminationReason);
fprintf(fileIdentifier, "\\newcommand{\\WalkFixedClockScreeningCount}{%d}\n", ...
    fixedClock.ScreeningCount);
fprintf(fileIdentifier, "\\newcommand{\\WalkFixedClockValidationCount}{%d}\n", ...
    fixedClock.ValidationCount);
fprintf(fileIdentifier, "\\newcommand{\\WalkFixedClockReason}{%s}\n", ...
    fixedClock.TerminationReason);
fprintf(fileIdentifier, "\\newcommand{\\WalkBarrierReason}{%s}\n", ...
    fixedClock.BarrierSequence.TerminationReason);
fprintf(fileIdentifier, "\\newcommand{\\WalkProgressReason}{%s}\n", ...
    fixedClock.ProgressPolynomial.TerminationReason);
fprintf(fileIdentifier, "\\newcommand{\\WalkTimedOpeningAttempted}{%s}\n", ...
    string(timedOpening.Attempted));
fprintf(fileIdentifier, "\\newcommand{\\WalkTimedOpeningReason}{%s}\n", ...
    timedOpening.TerminationReason);
fprintf(fileIdentifier, "\\newcommand{\\WalkCavityAttemptCount}{%d}\n", ...
    cavity.AttemptedSeedCount);
fprintf(fileIdentifier, "\\newcommand{\\WalkCavityReason}{%s}\n", ...
    cavity.Attempts{1}.Diagnostics.TerminationReason);
...
fprintf(fileIdentifier, "\\newcommand{\\WalkHomologyClassCount}{%d}\n", ...
    grid.HomologyClassCount);
