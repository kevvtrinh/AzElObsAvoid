...
function writeWalkthroughValues(dataDirectory, result, selectedSummary, obstacle, diagnosis)
    ...
    minimumTimeDetour = diagnosis.MinimumTimeDetour;
    grid              = diagnosis.Search;
    ...
    fprintf(fileIdentifier, "\\newcommand{\\WalkMinimumTimeDetourScreeningCount}{%d}\n", detailValue(minimumTimeDetour, "ScreeningCount"));
    fprintf(fileIdentifier, "\\newcommand{\\WalkMinimumTimeDetourValidationCount}{%d}\n", detailValue(minimumTimeDetour, "ValidationCount"));
    fprintf(fileIdentifier, "\\newcommand{\\WalkMinimumTimeDetourReason}{%s}\n", detailValue(minimumTimeDetour, "TerminationReason"));
