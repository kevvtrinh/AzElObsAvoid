...
\file{Verbose} & false & Console progress disabled. \\
...
\scriptentry{+obstacleAvoidance/+search/clusterSeedShape.m}{Optionally merges
nearby groups of at least three swept obstacle regions into conservative convex
hulls for topology seed generation. Original protected geometry remains the
authority for optimization associations and collision validation.}
