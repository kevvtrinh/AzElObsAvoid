...
function testSingleSpanTimedInfeasibilityReturnsNoMotion(testCase)
    ...
    [controls,duration_s,flag] = bmtpEngine.optimization.solveTrajectoryStep( ...
        request,timedStep(1,planes,1e-8,0.1,true,0,[]));
    ...
    for degree = [5,8]
        for horizon_s = [5,6,8,10]
            ...
            [controls,duration_s,flag,output] = bmtpEngine.optimization.solveTrajectoryStep( ...
                request,timedStep(1,planes,1e-8,horizon_s,true,0,[]));
...
function testTimedTrajectoryStepRetainsRelativeClock(testCase)
    ...
    [controls,duration_s,flag]=bmtpEngine.optimization.solveTrajectoryStep( ...
        request,timedStep(2,planes,1e-8,8,true,0,[1;3]));
    verifyTrue(testCase,flag>0 || flag==-7);
...
function step = timedStep(segmentCount, planes, roundoffReserve_units, ...
        maximumMotionDuration_s, fixedClock, minimumMotionDuration_s, segmentRatio)
