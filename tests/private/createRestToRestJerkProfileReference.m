function profile = createRestToRestJerkProfileReference(initialState, terminalState, limits, requestedFinalTime)
...
polynomial       = struct("SegmentCount", segmentCount, ...
    "SegmentStartTime_s", segmentStartTime, ...
    "SegmentDuration_s", phaseDuration, ...
    "FinalTime", finalTime, ...
    "positionPower_units", positionPower, ...
    "velocityPower_units_s", velocityPower, ...
    "accelerationPower_units_s2", accelerationPower, ...
    "jerkPower_units_s3", jerkPower, ...
