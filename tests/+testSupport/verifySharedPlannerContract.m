...
switch method
    case "corridor"
        adapter = struct( ...
            ...
            "GenerateTopologySeeds", ...
            @azElPlannerMethods.corridor.internal.search.generateTopologySeeds, ...
            "DenseSweptEnvelope", ...
            @azElPlannerMethods.corridor.internal.search.denseSweptEnvelope);
    case "hs3"
        adapter = struct( ...
            "FixedOptions", @() planAzElMotion("hs3"), ...
            "GenerateTopologySeeds", ...
            @azElPlannerMethods.hs3.internal.search.generateTopologySeeds, ...
            "DenseSweptEnvelope", ...
            @azElPlannerMethods.hs3.internal.search.denseSweptEnvelope);
    otherwise
...
function testDenseSweptEnvelopeIsConservativeAndProtectsEndpoints(testCase, adapter)
...
[envelopeShape, usedEnvelope] = adapter.DenseSweptEnvelope( ...
...
[capturingShape, usedCapturingEnvelope] = adapter.DenseSweptEnvelope( ...
...
[coarseShape, usedCoarseShape] = adapter.DenseSweptEnvelope( ...
...
[manyObstacleShape, usedManyObstacleEnvelope] = adapter.DenseSweptEnvelope( ...
