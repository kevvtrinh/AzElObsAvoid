...
function testStaticMeshIgnoresCollinearSeedVertices(testCase)
    ...
    firstRequest=bmtpEngine.pipeline.createSolveRequest(seed(route), ...
    ...
    secondRequest=bmtpEngine.pipeline.createSolveRequest(seed(midpointRoute), ...
        struct('regions_units', {cell(0,1)}, 'coverage', coverage), ...
        struct('initialState', normalized.Inputs.initialState, ...
        'goalState', normalized.Inputs.goalState, ...
        'limits', normalized.Limits, ...
...
function testSolveRequestRejectsIncompleteCoverage(testCase)
    ...
    verifyError(testCase,@()bmtpEngine.pipeline.createSolveRequest(routeSeed, ...
...
function [request, warmStart, diagnostics, target_units, roundoffReserve_units] = ...
    ...
    request = bmtpEngine.pipeline.createSolveRequest(seed(route_units), ...
