...
function outerRequest=createOuterRequest(request,requestContext,goalTime_s,trialTime_s)
    ...
    outerRequest=struct( ...
        ...
        'WrapX',true, ...
        'WrapY',false, ...
        'GoalTime_s',goalTime_s, ...
        'GoalTimeMode',request.options.GoalTimeMode, ...
        'FixedArrivalTrialTime_s',trialTime_s);
end
...
function names=timedFailureFieldNames()
    names={ ...
        ...
        'jerk_units_s3';'Polynomial';'PlaneCertificate';'SolverDiagnostics'; ...
