...
isOccupied = azElPlannerMethods.hs3.queryTimeObstacle(obstacles, 0, 0.75, 10);
...
occupied = azElPlannerMethods.hs3.queryTimeObstacle(obstacle, [0; 0], [0; 0], [0; 4]);
...
queryTime_s = [0; 0; 2];
fastOccupied = azElPlannerMethods.hs3.queryTimeObstacle(obstacle, queryAzimuth_deg, queryElevation_deg, queryTime_s);
[detailedOccupied, ~, details] = azElPlannerMethods.hs3.queryTimeObstacle(obstacle, queryAzimuth_deg, queryElevation_deg, queryTime_s);
...
obstacle = makeAzElObstacleData( ...
    ...
    {first_deg(:, 1); second_deg(:, 1)}, ...
    {first_deg(:, 2); second_deg(:, 2)}, 0);
occupied = azElPlannerMethods.hs3.queryTimeObstacle(obstacle, [1.5; 1.5], [0; 0], [0; 2]);
