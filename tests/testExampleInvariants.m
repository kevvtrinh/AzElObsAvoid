...
function testPhysicalRequirementHashes(testCase)
    ...
    % Re-reviewed for the planner API rename; physical setup is unchanged.
    expectedHashes = [ ...
        "67a62882e3e3b4898eebf7929d0934305a7c5723dc28679fea42aa9e6fb3bc12", ...
        "3b2508b0e3ad9d726a081c09352eb7bf892e55a84dab3087db50c4497e3c5a53", ...
...
function testVietnamKeepoutSlewRunsHeadlessly(testCase)
    ...
    selectedDetails = testSupport.solverDetails(resultDiagnosis, resultDiagnosis.SelectedAttemptIndex);
