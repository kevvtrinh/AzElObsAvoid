...
[candidate, diagnostics] = ...
    ...
    seed, obstacleAvoidance.planner.prepareStaticSolverGeometry( ...
        obstacleAvoidance.obstacles.prepareObstacles(obstacle), initialState.time_s, goalState.time_s), initialState, goalState, limits, options);
...
[candidate, diagnostics] = ...
    obstacleAvoidance.planner.solveStaticBmtpTrajectory( ...
    seed, obstacleAvoidance.planner.prepareStaticSolverGeometry( ...
        obstacleAvoidance.obstacles.prepareObstacles(obstacles), initialState.time_s, goalState.time_s), initialState, goalState, limits, options);
validation = obstacleAvoidance.validateTrajectory( ...
