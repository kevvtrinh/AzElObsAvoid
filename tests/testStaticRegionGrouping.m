...
[candidate, diagnostics] = ...
    ...
    seed, obstacleAvoidance.obstacles.prepareObstacles(obstacle), initialState, goalState, limits, options);
...
[candidate, diagnostics] = ...
    obstacleAvoidance.planner.solveBmtpTrajectory( ...
    seed, obstacleAvoidance.obstacles.prepareObstacles(obstacles), initialState, goalState, limits, options);
validation = obstacleAvoidance.validateTrajectory( ...
