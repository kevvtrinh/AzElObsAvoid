...
[candidate, ~] = obstacleAvoidance.planner.solveStaticBmtpTrajectory( ...
    seed, obstacleAvoidance.planner.prepareStaticSolverGeometry( ...
        obstacleAvoidance.obstacles.prepareObstacles(planningObstacles), initialState.time_s, goalState.time_s), initialState, goalState, limits, options);
...
interiorTime_s = initialState.time_s + seed.tau(2:end - 1) * ...
    candidate.TrajectoryDuration_s;
