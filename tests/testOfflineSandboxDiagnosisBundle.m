...
verifyFalse(testCase, contains(htmlText, ...
    'leaves the workspace during its motion.'));
verifyTrue(testCase, contains(htmlText, ...
...
verifyLessThan(testCase, selectedSummary.MotionLength_deg + selectedSummary.MotionDuration_s, 217, ...
    "Preserve the historical travel-plus-duration regression bound.");
if ~isempty(fieldnames(reproducedBundle.Result.SearchDiagnostics.Grid))
    ...
    verifyEqual(testCase, reproducedBundle.Result.SearchDiagnostics. ...
        AttemptedSeedCount, 1);
end
clear cleanup;
end
