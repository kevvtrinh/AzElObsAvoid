...
function testFixedMovingTargetTimedFallbackMatchesTargetDerivatives(testCase)
    ...
    verifyTrue(testCase, isfield(result.VisibilityGraph, 'SpatialSeedDiagnostics'), ...
        label + ": rejected spatial-seed evidence is missing.");
    verifyFalse(testCase, result.VisibilityGraph.SpatialSeedDiagnostics.Accepted, ...
        label + ": spatial seed was not actually rejected.");
