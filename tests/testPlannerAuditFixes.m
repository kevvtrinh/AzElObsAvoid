...
initial = struct('time_s', 0, 'position_deg', [-3 0]);
goal = struct('time_s', 10, 'position_deg', [3 0]);
limits = struct('maxVelocity_deg_s', [2 2], 'maxAcceleration_deg_s2', [1 1], ...
    'maxJerk_deg_s3', [2 2], 'azimuthInterval_deg', [-5 5], 'elevationInterval_deg', [-5 5]);
...
for regionCount = 1:2
    ...
    corridor = repmat(struct('SegmentIndex', 1, 'RegionIndex', 0, 'Normal', [0 0], ...
        'Clearance_deg', 0.5, 'BoundaryOffset_deg', -2), numel(regions), 1);
