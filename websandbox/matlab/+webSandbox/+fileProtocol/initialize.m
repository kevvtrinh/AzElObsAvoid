...
bundleImportDirectory = fullfile(protocolRoot, "bundles", "imports");
bundleExportDirectory = fullfile(protocolRoot, "bundles", "exports");
directories = [protocolRoot, requestDirectory, responseDirectory, ...
    nativeDirectory, bundleImportDirectory, bundleExportDirectory];
...
protocolInfo = struct( ...
    ...
    "BundleImportDirectory", string(bundleImportDirectory), ...
    "BundleExportDirectory", string(bundleExportDirectory));
end
