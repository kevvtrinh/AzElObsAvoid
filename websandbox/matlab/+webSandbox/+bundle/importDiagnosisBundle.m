...
descriptors = repmat(struct( ...
    ...
    "slices", struct( ...
        ...
        "protectedVertices_deg", zeros(0, 2))), numel(obstacles), 1);
...
slices = repmat(struct( ...
    "vertices_deg", zeros(0, 2), ...
    "protectedVertices_deg", zeros(0, 2)), sliceCount, 1);
for sliceIndex = 1:sliceCount
    ...
    slices(sliceIndex).protectedVertices_deg = [ ...
