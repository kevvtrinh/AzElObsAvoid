...
sampleTime  = unique([uniformTime; profile.Polynomial.SegmentStartTime_s; profile.FinalTime]);
[sampleTime, position, velocity, acceleration, jerk] = motionCore.evaluatePolynomial(profile.Polynomial, sampleTime);
