...
for direction = [1, -1]
    ...
    candidates = appendInitialAccelerationVelocityProfiles( ...
        candidates, context, directed);
...
minimumDuration = max((-context.a0 + aMaximum) / jMaximum, 0) + ...
    max(aMaximum / jMaximum, 0);
if duration < minimumDuration
    return;
end

commonTerm = 12 * jMaximum * ( ...
    -aMaximum^2 * velocityDifference - ...
    jMaximum * velocityDifference^2 + ...
    2 * aMaximum * jMaximum * ...
...
monicQuadratic = (context.a0Squared - context.afSquared + ...
    ...
    2 * jMaximum * (velocityDifference - aMaximum * duration)) / ...
    jSquared;
monicConstant = -( ...
    -3 * (context.a0Fourth + context.afFourth) + ...
    4 * (context.afCubed + 2 * context.a0Cubed) * aMaximum - ...
    12 * context.a0 * aMaximum * ...
    (context.afSquared - 2 * jMaximum * velocityDifference) + ...
    6 * context.a0Squared * (context.afSquared - aMaximum^2 - ...
    2 * jMaximum * velocityDifference) + ...
    6 * context.afSquared * (aMaximum^2 - ...
    2 * aMaximum * jMaximum * duration + ...
    2 * jMaximum * velocityDifference) + commonTerm) / ...
    (12 * jSquared^2);
...
maximumTime = min(duration - (2 * aMaximum - context.a0) / ...
    jMaximum, -aMinimum / jMaximum);
for rootIndex = 1:numel(rootsFound)
    ...
    if time > eps
        ...
        residual = ( ...
            -3 * (context.a0Fourth + context.afFourth) + ...
            4 * (context.afCubed + 2 * context.a0Cubed) * aMaximum - ...
            24 * context.af * aMaximum * jSquared * time^2 - ...
            12 * context.a0 * aMaximum * ...
            (context.afSquared - 2 * jMaximum * h1) + ...
            6 * context.a0Squared * (context.afSquared - aMaximum^2 - ...
            2 * jMaximum * h1) + ...
            6 * context.afSquared * (aMaximum^2 - ...
            2 * aMaximum * jMaximum * duration + 2 * jMaximum * h1) - ...
            12 * jMaximum * (aMaximum^2 * h1 + jMaximum * h1^2 + ...
            2 * aMaximum * jMaximum * (positionDifference + ...
            jMaximum * time^2 * (time - duration) - ...
            duration * context.vf))) / (24 * aMaximum * jSquared);
        derivative = -time * (context.a0Squared - context.afSquared + ...
            2 * aMaximum * (accelerationDifference - ...
            jMaximum * duration) + aMaximum^2 + ...
            3 * aMaximum * jMaximum * time + ...
            2 * jMaximum * h1) / aMaximum;
        if isfinite(derivative) && derivative ~= 0
            time = time - residual / derivative;
        end
    end
    h1 = ((context.a0Squared - context.afSquared) / 2 + ...
        jMaximum * (jMaximum * time^2 + velocityDifference)) / aMaximum;
    phase = [ ...
...
rootsFound = realNonnegativeRoots(polynomial);
minimumTime = context.af / jMaximum;
maximumTime = min(duration - aMaximum / jMaximum, ...
    aMaximum / jMaximum);
for rootIndex = 1:numel(rootsFound)
    time = rootsFound(rootIndex);
    if time < minimumTime || time > maximumTime
    ...
    residual = -( ...
        3 * (context.a0Fourth + context.afFourth) - ...
        4 * (2 * context.a0Cubed + context.afCubed) * aMaximum + ...
        24 * context.af * aMaximum * jSquared * time^2 - ...
        12 * context.a0 * aMaximum * ...
        (context.afSquared - 2 * jMaximum * h1) + ...
        6 * context.a0Squared * (context.afSquared + aMaximum^2 - ...
        2 * jMaximum * h1) + ...
        6 * context.afSquared * (aMaximum^2 - ...
        2 * jMaximum * (duration * aMaximum + h1)) + ...
        12 * jMaximum * (-aMaximum^2 * h1 + jMaximum * h1^2 - ...
        2 * aMaximum * jMaximum * (-positionDifference + ...
        jMaximum * time^2 * (time - duration) + ...
        duration * context.vf))) / (24 * aMaximum * jSquared);
    derivative = time * (context.a0Squared + context.afSquared - ...
        2 * jMaximum * h1 - ...
        2 * (context.a0 + context.af + jMaximum * duration) * ...
        aMaximum + aMaximum^2 + 3 * aMaximum * jMaximum * time) / ...
        aMaximum;
    if isfinite(derivative) && derivative ~= 0
        time = time - residual / derivative;
    end
    h1 = ((context.a0Squared + context.afSquared) / 2 + ...
        jMaximum * (velocityDifference - jMaximum * time^2)) / aMaximum;
    phase = [ ...
        (-context.a0 + aMaximum) / jMaximum, ...
        (h1 - aMaximum) / jMaximum, ...
        aMaximum / jMaximum, ...
    ...
    candidates = appendEvaluated(candidates, context.InitialState, ...
        context.TerminalState, context.Limits, phase, ...
        jMaximum * [1, 0, -1, 0, 1, 0, -1], ...
        "synchronizedAlternatingInitialAccelerationVelocity");
end
end
