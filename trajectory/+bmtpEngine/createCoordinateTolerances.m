...
%   lower bound of one degree. geometryTolerance_units (finite numeric scalar) Dyadic geometry
%   tolerance, 2^16 times eps(coordinateScale_units). roundoffReserve_units (finite numeric scalar)
