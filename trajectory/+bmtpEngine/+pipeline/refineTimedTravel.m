...
% Use the retained physical segment times that built these separating lines.
% Fixed-arrival requests use the other alternating solver.
...
for refinementIndex = 1:8
    trajectoryStep = struct( ...
        ...
        'SegmentRatio',            [], ...
        'SegmentTime_s',           originalSegmentTime_s, ...
