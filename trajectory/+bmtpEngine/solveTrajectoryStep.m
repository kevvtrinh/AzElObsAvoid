...
%       bmtpEngine.solveTrajectoryStep(segmentCount, degree, initialState, ...
...
boundaryControls = bmtpEngine.imposeEndpointControls( ...
...
if fixedClock
    ...
    if intrinsicVariation
        ...
        cones = [cones; bmtpEngine.createVariationCone( ...
...
function [x, exitFlag, output] = solveConic( ...
    ...
    if ~isempty(phaseTimes_s)
        ...
        cones(end - phaseCount + 1:end) = bmtpEngine.createVariationCone( ...
