...
trajectoryOptions = struct("MaxIterations", maximumTrajectoryIterations);
planeOptions = struct();
tightPlaneOptions = struct( ...
...
problem = struct( ...
    ...
    "LowerBound", lb, ...
    "UpperBound", ub);
solverResult = conicSolver.solve(problem, options);
x = solverResult.PrimalSolution;
...
problem = struct( ...
    ...
    "LowerBound", -Inf(variableCount, 1), ...
