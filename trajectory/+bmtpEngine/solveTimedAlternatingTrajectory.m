...
feasibleSegmentTime_s = mean(warmStart.SegmentTime_s);
...
for iterationIndex = 1:35
    ...
    [trialControl_units, trialTime_s, exitFlag, output] = ...
        bmtpEngine.solveTimedTrajectoryStep(segmentCount,degree, ...
        request.InitialState.position_units,request.GoalState.position_units, ...
        request.Limits,planes,roundoffReserve_units,optimizationHorizon_s, ...
        "earliestArrival",timedOptions,request.MinimumMotionDuration_s);
