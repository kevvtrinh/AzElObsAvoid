function [preparedMotion, motionCheck, savedPairChecks, unverifiedPairsBySegment] = evaluateCandidate( ...
...
%       bmtpEngine.evaluateCandidate(solverRequest, controlPoint_units, segmentTime_s, ...
%       roundoffReserve_units, separationTarget_units, ...
%       suppliedPowerCoefficients_units, checkMode, savedPairChecks)
%**************************************************************************
% PURPOSE
...
%   - unverifiedPairsBySegment (S-by-R logical array or false(0, 0))
%       Unproved pairs from subdivided pieces, mapped to original segments.
%       Empty when no subdivision check runs.
%**************************************************************************
% UNITS
...
unverifiedPairsBySegment = false(0, 0);
