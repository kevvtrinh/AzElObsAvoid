...
for segmentIndex = 1:segmentCount
    ...
    positionPower_deg(segmentIndex, :, :) = reshape([position_deg; ...
        velocity_deg_s * step_s; acceleration_deg_s2 * step_s ^ 2 / 2; ...
        jerk_deg_s3 * step_s ^ 3 / 6].', 1, dimensionCount, 4);
    velocityPower_deg_s(segmentIndex, :, :) = reshape([velocity_deg_s; ...
        acceleration_deg_s2 * step_s; jerk_deg_s3 * step_s ^ 2 / 2].', ...
        1, dimensionCount, 3);
    accelerationPower_deg_s2(segmentIndex, :, :) = reshape([ ...
        acceleration_deg_s2; jerk_deg_s3 * step_s].', ...
        1, dimensionCount, 2);
