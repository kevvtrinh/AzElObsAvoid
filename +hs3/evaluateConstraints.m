...
% SYNTAX
%   [inequality, equality] = hs3.evaluateConstraints(decision, ...
...
%       hs3.evaluateConstraints(decision, isFreeTime, fixedFinalTime, ...
%       minimumFinalTime, maximumFinalTime, segmentCount, initialState, ...
%       terminalState, limits, pathConstraints)
%**************************************************************************
% PURPOSE
...
[inequalityMatrix, equalityMatrix] = hs3.buildFixedConstraintMatrices( ...
...
%**************************************************************************
% INPUTS
%   - Solver and contract inputs match hs3.evaluateConstraints.
%**************************************************************************
% OUTPUTS
...
bernstein = hs3.powerToBernstein(powerMatrix);
bernstein = bernstein(:);
end
