...
% SYNTAX
%   value = hs3.integratedSquaredJerk(decision, isFreeTime, ...
%       fixedFinalTime, segmentCount, startTime, dimensionCount)
%   [value, gradient] = hs3.integratedSquaredJerk(decision, isFreeTime, ...
%       fixedFinalTime, segmentCount, startTime, dimensionCount)
%   [value, gradient, hessian] = hs3.integratedSquaredJerk( ...
