...
% SYNTAX
%   solution = hs3.solveFixedTime(initialState, terminalState, limits, ...
...
[~, ~, jerkHessian] = hs3.integratedSquaredJerk( ...
...
problem = struct( ...
    ...
    "ObjectiveFunction", @(decision) hs3.integratedSquaredJerk( ...
