...
This root package is the dimension-neutral kinematic engine extracted from
the azimuth/elevation planner. Its public target is:
...
solving, and HS3 diagnostics. It may consume optional coordinate-space affine
point constraints or exact single-segment interval constraints through
Bernstein hulls.
