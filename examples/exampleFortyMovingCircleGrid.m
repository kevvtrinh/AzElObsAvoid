...
[options, jerkConfiguration] = resolveAzElExampleOptions( ...
    exampleOverrides, struct( ...
        ...
        "MaximumVisibilitySnapshotsPerObstacle", 6, ...
...
for rowIndex = 1:numel(rowElevation_deg)
    for columnIndex = 1:numel(columnAzimuth_deg)
        ...
        centerElevation_deg(:, obstacleIndex) = ...
            rowElevation_deg(rowIndex) + verticalTranslation_deg;
...
centerTranslation_deg = centerElevation_deg - ...
    centerElevation_deg(1, :);
relativeSpacingPreserved = all(abs(centerTranslation_deg - ...
    verticalTranslation_deg) <= spacingTolerance_deg, "all");
...
gridValidation = struct( ...
    ...
    "RelativeSpacingPreserved", relativeSpacingPreserved, ...
