...
regionDiagnostics = cell(regionCount, 1);
for regionIndex = 1:regionCount
    ...
    [regionResults{regionIndex}, regionDiagnostics{regionIndex}] = ...
        planAzElMotion( ...
...
for regionIndex = 1:regionCount
    ...
    diagnosticsForRegion = regionDiagnostics{regionIndex};
    exampleValidation = validateAzElExampleResult( ...
        resultForRegion, diagnosticsForRegion, ...
...
if jerkConfiguration.PlotOutputs
    for regionIndex = 1:regionCount
        ...
        regionResults{regionIndex}.PlotHandles = plotAzElMotion( ...
            regionResults{regionIndex}, ...
            regionDiagnostics{regionIndex}, plotOptions);
    end
end
