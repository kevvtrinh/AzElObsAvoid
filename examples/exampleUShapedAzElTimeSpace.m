...
result.ExampleValidation = validateAzElExampleResult( result, "single U", struct("RequireDirectBlocked", true));
...
result.ExampleGeometry = struct( ...
    ...
    "obstaclePosition_deg", obstaclePosition_deg, "safetyMargin_deg", safetyMargin_deg);
end
