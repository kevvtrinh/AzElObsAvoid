...
exampleValidation = validateAzElExampleResult( ...
    result, diagnostics, "four accelerating circles", ...
...
targetEndpointError_deg = norm( ...
    result.TargetPositionAtIntercept_deg - targetPosition_deg(end, :));
targetSpeedAtIntercept_deg_s = norm( ...
    result.TargetVelocityAtIntercept_deg_s);
movingTargetValidation = struct( ...
    "Passed", result.InterceptValidation.Passed && ...
        targetTravel_deg > 0 && targetEndpointError_deg <= 1e-10 && ...
        targetSpeedAtIntercept_deg_s > 0, ...
    "InterceptPassed", result.InterceptValidation.Passed, ...
    ...
    "PositionOnlyCapture", ~result.Options.MatchTargetVelocity);
