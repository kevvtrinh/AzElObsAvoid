...
if expectedSuccess
    passed = formatIsStable && result.Success && trajectoryValidation.Passed && diagnosticsAreConsistent && directRequirementPassed;
else
...
if passed
    ...
    message = scenarioLabel + " failed example validation. " + "Success=" + string(logical(result.Success)) + ", reason=" + string(result.TerminationReason) + ", diagnostics=" + string(diagnosticsAreConsistent) + ", directBlocked=" + string(directRouteBlocked) + ".";
end
