...
if passed
    ...
    message = scenarioLabel + " failed example validation. " + "Success=" + logicalText(result.Success) + ", reason=" + string(result.TerminationReason) + ", diagnostics=" + string(diagnosticsAreConsistent) + ", directBlocked=" + string(directRouteBlocked) + ".";
end
