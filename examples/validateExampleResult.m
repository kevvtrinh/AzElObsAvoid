...
formatIsStable = all(isfield(result, requiredFields)) && ...
    ...
    isfield(result.Diagnostics, 'Route_units');
...
diagnosticsAreConsistent = formatIsStable && isfield(result.Diagnostics, 'VisibilityGraph') && ...
    diagnosticCountsAreValid(result.Diagnostics.VisibilityGraph);
