...
if result.Success && all(isfinite(result.Diagnostics.Intercept.TargetPosition_units))
    targetIsClearAtIntercept = ...
        ~obstacleAvoidance.obstacles.queryObstacleOccupancyAtTime( ...
        result.Inputs.obstacles, result.Diagnostics.Intercept.TargetPosition_units(1), ...
        result.Diagnostics.Intercept.TargetPosition_units(2), result.Diagnostics.Intercept.Time_s, ...
