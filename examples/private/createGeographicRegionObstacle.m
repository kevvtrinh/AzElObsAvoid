...
%**************************************************************************
% PURPOSE
%   - Build a static, tolerance-reduced geographic obstacle for the maintained
...
boundaryTolerance_deg = 0.02;
[latitude_deg, longitude_deg, relativeArcLengthError, ...
    appliedBoundaryTolerance_deg] = reducem( ...
    latitude_deg, longitude_deg, boundaryTolerance_deg);
reducedShape = polyshape( ...
    longitude_deg, latitude_deg, ...
    "Simplify", true, "KeepCollinearPoints", true);
[longitude_deg, latitude_deg] = boundary(reducedShape);
finiteBoundary = isfinite(longitude_deg) & isfinite(latitude_deg);
warning("createGeographicRegionObstacle:BoundarySimplified", ...
    "Reduced the %s boundary from %d to %d vertices with a %.6g deg " + ...
    "tolerance. Planning uses the simplified geometry.", ...
    regionName, nativeVertexCount, nnz(finiteBoundary), ...
...
history = struct( ...
    ...
    "boundaryTolerance_deg", appliedBoundaryTolerance_deg, ...
    "relativeArcLengthError", relativeArcLengthError, ...
