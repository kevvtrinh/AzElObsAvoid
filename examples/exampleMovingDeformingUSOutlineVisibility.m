...
%       Expected bounded failure plus independent ExampleValidation,
%       ObstacleHistory, and ExampleConfiguration metadata. A failure is
%       not a no-path certificate.
%**************************************************************************
% UNITS
...
[obstacle, obstacleHistory] = createContiguousUSObstacle( ...
    obstacleTime_s, safetyMargin_deg, struct( ...
    "MotionMode", "movingDeforming", ...
    "BoundaryTolerance_deg", boundaryTolerance_deg, ...
...
exampleValidation = validateAzElExampleResult( ...
    ...
    struct("ExpectedSuccess", false, "RequireDirectBlocked", true));
