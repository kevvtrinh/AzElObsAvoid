...
[options, displayOptions] = resolveAzElExampleOptions( ...
    ...
    "CollocationSegmentCount", 5, "MaximumPlanningTime_s", 20, ...
...
obstacles = makeAzElObstacleData( ...
    "full-height wall", obstacleTime_s, ...
    obstacleAzimuth_deg, obstacleElevation_deg, 0);
...
recognizedReason = any(result.TerminationReason == ...
