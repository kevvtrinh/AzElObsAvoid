...
%**************************************************************************
% PURPOSE
%   - Interpolate the three supplied Vietnam azimuth/elevation boundaries
%     into one canonical moving obstacle history.
%**************************************************************************
% INPUTS
%   - None
%       examples/data/vietnamBoundaryPoints.csv supplies the source decimals.
%**************************************************************************
% OUTPUTS
%   - obstacles (scalar obstacle struct)
%       Canonical obstacle with 921 normalized slices of 275 vertices.
%   - initialState (scalar struct)
%       Start time and position of the supplied request.
%   - goalState (scalar struct)
%       Arrival time and position of the supplied request.
%   - limits (scalar struct)
%       Workspace intervals and per-axis motion limits.
%**************************************************************************
% UNITS
%   - Positions are 1-by-2 [azimuth elevation] rows in degrees. Time is
%     seconds; derivatives use deg/s, deg/s^2, and deg/s^3.
%**************************************************************************
...
anchorRows_deg   = reshape(permute(anchorVertices_deg, [3, 1, 2]), 3, []);
interpolated_deg = interp1(anchorTime_s, anchorRows_deg, time_s, 'linear');
