...
[targetOccupied, blockingObstacleIndex] = queryAzElTimeObstacle( ...
    result.Inputs.obstacles, targetAzimuth_deg, targetElevation_deg, ...
    occupancyTime_s);
...
[probeOccupied, probeBlockingObstacleIndex] = queryAzElTimeObstacle( ...
    result.Inputs.obstacles, probeAzimuth_deg, probeElevation_deg, ...
    probeTime_s);
...
catchOccurredBeforeTrackEnd = result.Success && ...
    result.Intercept.Time_s < missionEndTime_s;
