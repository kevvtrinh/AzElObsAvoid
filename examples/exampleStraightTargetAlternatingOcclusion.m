...
exampleValidation = validateAzElExampleResult( ...
    result, diagnostics, "straight target with alternating occlusion", ...
...
[targetOccupied, blockingObstacleIndex] = queryAzElTimeObstacle( ...
    ...
    targetAzimuth_deg, targetElevation_deg, ...
    occupancyTime_s);
...
[probeOccupied, probeBlockingObstacleIndex] = queryAzElTimeObstacle( ...
    diagnostics.Planner.ObstacleField, ...
    probeAzimuth_deg, probeElevation_deg, ...
    probeTime_s);
...
if result.Success
    ...
    interceptTargetIsClear = ~queryAzElTimeObstacle( ...
        diagnostics.Planner.ObstacleField, ...
        result.TargetPositionAtIntercept_deg(1), ...
