...
squareObstacle = azElObstacles.makeAzElObstacleData( ...
...
circleObstacle = azElObstacles.makeAzElObstacleData( ...
...
starObstacle = azElObstacles.makeAzElObstacleData( ...
...
uObstacle = azElObstacles.makeAzElObstacleData( ...
    "U shape", obstacleTime_s, ...
    {uPosition_deg(:, 1); uPosition_deg(:, 1)}, {uPosition_deg(:, 2); uPosition_deg(:, 2)}, safetyMargin_deg);

obstacles = azElObstacles.combineAzElObstacles( squareObstacle, circleObstacle, starObstacle, uObstacle);
...
[targetOccupied, blockingObstacleIndex] = azElObstacles.queryAzElTimeObstacle( ...
...
[probeOccupied, probeBlockingObstacleIndex] = azElObstacles.queryAzElTimeObstacle( ...
...
if result.Success
    ...
    interceptTargetIsClear = ~azElObstacles.queryAzElTimeObstacle( ...
