...
obstacles = obstacleAvoidance.obstacles.createObstacle("dense concave polygon", ...
    obstacleTime_s, obstacleX_units, obstacleY_units, safetyMargin_units);
...
initialState = struct("time_s", 0, "position_units", [-6 0]);
goalState    = struct("time_s", 15, "position_units", [6 0]);
limits       = struct( ...
