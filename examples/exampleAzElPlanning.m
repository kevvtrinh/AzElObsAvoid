...
%       UseParallel selects parallel polygon-search work when available.
%**************************************************************************
% OUTPUTS
...
controls = struct("FigureVisible", "on", "PlotOutputs", true, ...
    ...
    "EnableJerkConstraint", true, "UseParallel", false, ...
    "Verbose", false);
...
logicalNames = ["PlotOutputs" "ShowAnimation" ...
    "ShowKinematicPlot" "ShowVisibilityGraphs" ...
    "EnableJerkConstraint" "Verbose"];
...
options = struct("GoalTimeMode", "earliestArrival", ...
    ...
    "UseParallel", controls.UseParallel, ...
...
if controls.PlotOutputs
    result.PlotHandles = plotAzElMotion(result, struct( ...
        ...
        "ShowVisibilityGraphs", controls.ShowVisibilityGraphs, ...
