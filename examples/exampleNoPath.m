...
%       Unmodified public planner failure result. This scenario expects an
%       ordinary no-path outcome with Success = false; invalid input throws.
%**************************************************************************
% UNITS
...
scenarioDefaults = struct("GoalTimeMode", "earliestArrival", "WrapX", false);
...
obstacles       = obstacleAvoidance.obstacles.createObstacle( ...
    "full-height wall", obstacleTime_s, obstacleX_units, obstacleY_units, 0);
...
exampleValidation = struct( ...
    "Passed",                 failureIsStable, ...
    "Message",                failureMessage, ...
    "PlannerReportedSuccess", result.Success, ...
    "RecognizedReason",       recognizedReason, ...
