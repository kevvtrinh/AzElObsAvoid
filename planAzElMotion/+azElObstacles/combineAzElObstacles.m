function obstacleField = combineAzElObstacles(varargin)
%% Section 0: Header & Readme
% SYNTAX
%   obstacles = azElObstacles.combineAzElObstacles()
%   obstacles = azElObstacles.combineAzElObstacles([])
%   obstacles = azElObstacles.combineAzElObstacles(obstacle1, obstacle2, ...)
%   obstacles = azElObstacles.combineAzElObstacles(obstacleArray)
%   obstacles = azElObstacles.combineAzElObstacles(nestedObstacleCells)
%**************************************************************************
% PURPOSE
...
if nargin == 0
    obstacleField = emptyCanonicalAzElObstacles();
    return;
end
...
for obstacleIndex = 1:numel(obstacleItems)
    normalizedObstacles{obstacleIndex} = ...
        azElObstacles.makeAzElObstacleData( ...
            obstacleItems{obstacleIndex});
end
obstacleField = vertcat(normalizedObstacles{:});
end

function obstacleField = emptyCanonicalAzElObstacles()
