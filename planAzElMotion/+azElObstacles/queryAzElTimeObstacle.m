...
% SYNTAX
%   options = azElObstacles.queryAzElTimeObstacle()
...
%       azElObstacles.queryAzElTimeObstacle( ...
...
%       PlannerMethod may be omitted or equal "hs3" and is echoed for
%       request provenance.
%**************************************************************************
% OUTPUTS
