...
% SYNTAX
%   corridor = azElSearch.buildSeedCorridor(seed, segmentCount)
%**************************************************************************
% PURPOSE
...
corridorRegions = azElGeometry.convexPolygonRegions(corridorShape);
...
for segmentIndex = 1:segmentCount
    ...
    for regionIndex = 1:numel(corridorRegions)
        ...
        [distance_deg, nearestPoint_deg] = azElGeometry.pointPolygonClearance( ...
