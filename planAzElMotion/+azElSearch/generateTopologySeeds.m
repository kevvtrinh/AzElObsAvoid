...
goal_deg = azElInput.goalPositionAtTime(goalState, goalState.time_s);
...
[sweptShape, usedDenseEnvelope] = azElSearch.denseSweptEnvelope( ...
...
[sweptShape, diagnostics.SeedCluster] = azElSearch.clusterSeedShape( ...
    sweptShape, options.SeedClusterDistance_deg, [start_deg; goal_deg], ...
        "azElSearch:clusterSeedShape:InvalidShape");
...
[edgeStart_deg, edgeEnd_deg] = azElGeometry.boundaryToEdges(sweptShape, 1e-12);
...
sampleTimes_s = azElSearch.boundedTimeLayers( ...
