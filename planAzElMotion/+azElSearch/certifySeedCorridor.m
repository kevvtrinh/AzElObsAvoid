...
% SYNTAX
%   [certified, minimumClearance_deg] = azElSearch.certifySeedCorridor( ...
...
envelopeRegions = azElGeometry.convexPolygonRegions(envelopeShape);
...
if ~azElSearch.seedEnvelopeContainsObstacles( boundary_deg, obstacles, tolerance_deg)
    return;
end
...
inequality_deg = azElSearch.seedCorridorInequality( ...
