...
inequality = [continuousBoundConstraints(polynomial, limits, options); ...
    azElSearch.seedCorridorInequality(polynomial, seedCorridor); ...
    corridorInequality];
goalPosition_deg = azElInput.goalPositionAtTime(goalState, finalTime_s);
...
bernstein = hs3Internal.powerToBernstein(coefficientMatrix);
