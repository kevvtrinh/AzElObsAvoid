function [time_s, position_deg, velocity_deg_s, ...
        acceleration_deg_s2, jerk_deg_s3] = evaluateAzElPolynomial( ...
        polynomial, time_s, segmentIndex)
%% Section 0: Header & Readme
% SYNTAX
%   [time_s, position_deg, velocity_deg_s, acceleration_deg_s2, ...
%       jerk_deg_s3] = azElPlanner.evaluateAzElPolynomial(polynomial, time_s)
%   [time_s, position_deg, velocity_deg_s, acceleration_deg_s2, ...
%       jerk_deg_s3] = azElPlanner.evaluateAzElPolynomial( ...
%       polynomial, time_s, segmentIndex)
%**************************************************************************
% PURPOSE
...
[time_s, position_deg, velocity_deg_s, acceleration_deg_s2, jerk_deg_s3] = ...
    hs3Internal.evaluatePolynomial(enginePolynomial, time_s, segmentIndex);
end
