...
% SYNTAX
%   [clearance_deg, nearestPoint_deg, edgeIndex] = azElGeometry.pointPolygonClearance(shape, point_deg)
%**************************************************************************
% PURPOSE
...
if ~isa(shape, "polyshape") || ~isscalar(shape)
    error("azElGeometry:pointPolygonClearance:InvalidShape", ...
...
[edgeStart_deg, edgeEnd_deg] = azElGeometry.boundaryToEdges(shape, 0);
