...
for orderIndex = 1:numel(improvementOrder)
    ...
    if ~isfinite(improvementDeadline_s)
        ...
        solverOptions.MaximumNlpFunctionEvaluations = ...
            requiredNlpEvaluations;
    end
...
result.SearchDiagnostics.SeedGenerationElapsedTime_s = ...
    gridDiagnostics.ElapsedTime_s;
result.SearchDiagnostics.FirstMotionElapsedTime_s = ...
