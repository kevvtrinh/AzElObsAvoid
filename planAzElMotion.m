...
result = azElInternal.runAzElCorridorPlanner( ...
...
if ~isscalar(options.MotionMethod) || ...
        options.MotionMethod ~= "corridorQuintic"
    error("planAzElMotion:InvalidMotionMethod", ...
        "MotionMethod must be corridorQuintic on this replacement branch.");
end
