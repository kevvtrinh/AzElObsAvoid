function [profileTime_s, azimuthBySlice_deg, elevationBySlice_deg] = createSandboxPolygonMotionHistory(polygon_deg, time_s, motionVector_deg, motionProfile)
...
validateattributes(polygon_deg, {'numeric'}, {'real', 'finite', '2d', 'ncols', 2, 'nonempty'});
if size(polygon_deg, 1) < 3
    error("createSandboxPolygonMotionHistory:TooFewVertices", "polygon_deg must contain at least three vertices.");
end
validateattributes(time_s, {'numeric'}, {'real', 'finite', 'vector', 'numel', 2, 'increasing'});
validateattributes(motionVector_deg, {'numeric'}, {'real', 'finite', 'row', 'numel', 2});
