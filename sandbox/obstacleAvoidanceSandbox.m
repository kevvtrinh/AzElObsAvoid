...
controls.WaypointWarmStartHandle = addPopupControl( ...
    plannerOptionsPanelHandle, "Waypoint warm start", 0.68, ...
    ["None", "Ruckig pass-through"], ...
    1 + double(options.PlannerOptions.WaypointWarmStartMode == ...
        "passThrough"), ...
    "Use Ruckig-derived pass-through states to warm-start eligible HS3 routes.");
controls.GoalTimeModeHandle = addPopupControl( ...
    plannerOptionsPanelHandle, "Goal timing", 0.39, ...
    ["Earliest arrival", "Fixed at horizon"], ...
    1 + double(options.PlannerOptions.GoalTimeMode == "fixedArrival"), ...
    "Choose earliest arrival or require arrival at the mission horizon.");
...
waypointWarmStartModes = ["none", "passThrough"];
controls = struct( ...
    ...
    "WaypointWarmStartMode", waypointWarmStartModes( ...
        get(handles.WaypointWarmStartHandle, "Value")), ...
...
set(handles.WaypointWarmStartHandle, "Value", 1 + double( ...
    options.PlannerOptions.WaypointWarmStartMode == "passThrough"));
set(handles.GoalTimeModeHandle, "Value", 1 + double( ...
