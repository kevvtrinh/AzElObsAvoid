...
% SYNTAX
%   containsAllObstacles = azElInternal.validation.seedEnvelopeContainsObstacles( ...
...
for obstacleIndex = 1:numel(obstacles)
    ...
    for sampleIndex = 1:numel(obstacle.time_s)
        obstacleShape = azElInternal.obstacles.shapeAtTime( obstacle, obstacle.time_s(sampleIndex));
