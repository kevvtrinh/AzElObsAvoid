...
% SYNTAX
%   [certified, minimumClearance_deg] = azElInternal.validation.certifySeedCorridor( ...
...
envelopeRegions = azElInternal.geometry.convexPolygonRegions(envelopeShape);
...
if ~azElInternal.validation.seedEnvelopeContainsObstacles( boundary_deg, obstacles, tolerance_deg)
    return;
end
...
inequality_deg = azElInternal.validation.seedCorridorInequality( trajectory.Polynomial, corridor);
