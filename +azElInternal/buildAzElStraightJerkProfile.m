function profile = buildAzElStraightJerkProfile(route_deg, initialState, limits)
...
if ~any(activeAxis)
    ...
    scalarAccelerationLimit_s2 = min( ...
        limits.maxAcceleration_deg_s2(activeAxis) ./ abs(delta_deg(activeAxis)));
...
polynomial = struct( ...
    ...
    "position_deg", route_deg(2, :), "velocity_deg_s", [0 0], ...
