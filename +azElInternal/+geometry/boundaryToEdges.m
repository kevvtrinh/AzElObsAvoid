...
% SYNTAX
%   [edgeStart_deg, edgeEnd_deg] = azElInternal.geometry.boundaryToEdges( ...
%       shape, closureTolerance_deg)
%**************************************************************************
% PURPOSE
...
if ~isa(shape, "polyshape") || ~isscalar(shape)
    error("azElInternal:boundaryToEdges:InvalidShape", "shape must be a scalar polyshape.");
end
