...
if needsClearanceRetry && candidateOffsetMultiplier < ...
        maximumCandidateOffsetMultiplier
    [nodePosition_deg, edgeCost_deg, record] = buildVisibilityGraph( ...
        sweptShape, start_deg, goal_deg, limits, true, 4 * ...
        candidateOffsetMultiplier, candidateOffsetRetryCount + 1);
    return;
end
record = struct( ...
...
occupied = queryAzElTimeObstacle(obstacles, samplePosition_deg(:, 1), ...
