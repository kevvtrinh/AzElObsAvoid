...
if ~isEarliestArrival
    ...
    [linearInequalityMatrix, linearInequalityBound, linearEqualityMatrix, ...
        linearEqualityBound] = azElInternal.linearizeAzElHs3Constraints( ...
...
if isEarliestArrival
    ...
    stageOneObjective = @(decision) ...
        azElInternal.integratedSquaredAzElHs3Jerk( ...
...
try
    ...
    candidate.SolverDiagnostics.SegmentCount = segmentCount;
    candidate.SolverDiagnostics.DecisionVariableCount = numel(decision0);
    candidate.SolverDiagnostics.ElapsedTime_s = toc(solverTimer);
    return;
end
...
candidate = struct( ...
    ...
    "SegmentCount", segmentCount, "DecisionVariableCount", ...
    numel(selectedDecision), ...
    "InequalityConstraintCount", numel(finalInequality), ...
    "EqualityConstraintCount", numel(finalEquality), ...
...
candidate = struct( ...
    ...
    "SegmentCount", segmentCount, "DecisionVariableCount", NaN, ...
    "InequalityConstraintCount", NaN, ...
    "EqualityConstraintCount", NaN, ...
