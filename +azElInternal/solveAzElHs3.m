...
desiredPosition_deg = interp1(seed.tau, seed.position_deg, ...
    controlTau, "linear");
evaluationTime_s = initialState.time_s + ...
...
[~, basePosition_deg, baseVelocity_deg_s, ...
    baseAcceleration_deg_s2] = azElInternal.evaluateAzElPolynomial( ...
    basePolynomial, evaluationTime_s);
desiredPosition_deg(end, :) = ...
    azElInternal.goalPositionAtTime(goalState, finalTime_s);
...
for controlIndex = 1:controlCount
    ...
    [~, basisPosition_deg, basisVelocity_deg_s, ...
        basisAcceleration_deg_s2] = ...
        azElInternal.evaluateAzElPolynomial( ...
        basisPolynomial, evaluationTime_s);
    positionMap(:, controlIndex) = ...
        basisPosition_deg(2:end, 1) - basePosition_deg(2:end, 1);
    terminalVelocityMap(controlIndex) = ...
        basisVelocity_deg_s(end, 1) - baseVelocity_deg_s(end, 1);
    terminalAccelerationMap(controlIndex) = ...
        basisAcceleration_deg_s2(end, 1) - ...
        baseAcceleration_deg_s2(end, 1);
end
fitMatrix = [positionMap; 5 * terminalVelocityMap; ...
    5 * terminalAccelerationMap];
fitOffset = [ ...
    desiredPosition_deg(2:end, :) - basePosition_deg(2:end, :); ...
    5 * (goalState.velocity_deg_s - baseVelocity_deg_s(end, :)); ...
    5 * (goalState.acceleration_deg_s2 - ...
    baseAcceleration_deg_s2(end, :))];
