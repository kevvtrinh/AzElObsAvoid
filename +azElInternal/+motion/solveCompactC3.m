...
if ~isempty(obstacles) && useExactCorridor
    seed.position_deg = ...
        azElInternal.motion.expandRouteClearance( ...
...
affineModel = ...
    azElInternal.motion.buildFixedDurationAffineModel( ...
...
straight = azElInternal.motion.buildQuinticSpline( ...
    ...
    "ConstraintTolerance", plannerOptions.ConstraintTolerance, ...
    "CollisionClearanceTolerance_deg", ...
    plannerOptions.CollisionClearanceTolerance_deg, ...
    "CollisionMinimumTimeStep_s", ...
    plannerOptions.CollisionMinimumTimeStep_s));
...
fixedPolynomial = ...
    azElInternal.motion.convertBsplineToPolynomial( ...
