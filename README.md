...
- Fixed-clock amplitude boundaries retain the independently validated side of
  each bracket and stop at a 0.001-degree physical resolution or after twelve
  bisections. The achieved reserve, target, and cap are returned in diagnostics.
