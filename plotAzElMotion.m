...
%       diagnostic plot controls, and global display budgets.
%**************************************************************************
% OUTPUTS
...
if result.Success && options.ShowAnimation
    ...
    animationOptions = struct( ...
        ...
        "MaximumAnimationFrameCount", ...
            options.MaximumAnimationFrameCount, ...
        ...
        "MaximumDisplayedTotalSlices", ...
            options.MaximumDisplayedTotalSlices, ...
...
validateattributes(options.MaximumDisplayedSlicesPerObstacle, {'numeric'}, ...
    {'scalar','integer','positive'});
validateattributes(options.MaximumDisplayedTotalSlices, {'numeric'}, ...
    {'scalar','integer','positive'});
validateattributes(options.MaximumAnimationFrameCount, {'numeric'}, ...
    {'scalar','integer','>=',2});
