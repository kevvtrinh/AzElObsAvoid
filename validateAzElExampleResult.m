...
isLogicalScalar = islogical(requireDirectBlocked) && ...
    isscalar(requireDirectBlocked);
isBinaryNumericScalar = isnumeric(requireDirectBlocked) && ...
    isreal(requireDirectBlocked) && isfinite(requireDirectBlocked) && ...
    isscalar(requireDirectBlocked) && ...
    any(requireDirectBlocked == [0 1]);
if ~(isLogicalScalar || isBinaryNumericScalar)
    error("validateAzElExampleResult:InvalidRequireDirectBlocked", ...
        "RequireDirectBlocked must be scalar logical or binary numeric.");
end
requireDirectBlocked = logical(requireDirectBlocked);
