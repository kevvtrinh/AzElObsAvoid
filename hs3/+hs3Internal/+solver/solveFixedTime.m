...
% SYNTAX
%   solution = hs3Internal.solver.solveFixedTime(initialState, terminalState, limits, ...
...
problem = struct( ...
    ...
    "ObjectiveFunction", @(decision) hs3Internal.polynomial.evaluateIntegratedSquaredJerk( ...
