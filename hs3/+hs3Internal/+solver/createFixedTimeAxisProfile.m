...
% SYNTAX
%   profile = hs3Internal.solver.createFixedTimeAxisProfile( ...
%       initialState, terminalState, limits, duration)
%   [profile, candidates] = hs3Internal.solver.createFixedTimeAxisProfile( ...
%       initialState, terminalState, limits, duration)
%**************************************************************************
% PURPOSE
...
minimumProfile = hs3Internal.solver.createMinimumTimeAxisProfile( ...
...
if (2 * (aMaximum - aMinimum) + ...
    ...
    root = safeSqrt(radical) * abs(jMaximum) / jMaximum;
    if isfinite(root)
        phase = zeros(1, 7);
