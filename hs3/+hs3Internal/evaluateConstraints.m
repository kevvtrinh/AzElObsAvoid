...
% SYNTAX
%   [inequality, equality] = hs3Internal.evaluateConstraints(decision, ...
...
%       hs3Internal.evaluateConstraints(decision, isFreeTime, fixedFinalTime, ...
%       minimumFinalTime, maximumFinalTime, segmentCount, initialState, ...
%       terminalState, limits, pathConstraints)
%**************************************************************************
% PURPOSE
...
%% Section 0: Header & Readme
% SYNTAX
%   [inequality, equality, finalTime] = constraintValues(decision, ...
%       isFreeTime, fixedFinalTime, segmentCount, initialState, ...
%       terminalState, limits, pathConstraints)
%**************************************************************************
% PURPOSE
...
%**************************************************************************
% INPUTS
%   - Solver and contract inputs match hs3Internal.evaluateConstraints.
%**************************************************************************
% OUTPUTS
%   - inequality, equality (numeric columns), raw constraints.
%   - finalTime (finite scalar), reconstructed terminal time.
%**************************************************************************
% UNITS
...
%% Section 0: Header & Readme
% SYNTAX
%   inequality = affinePathConstraints(polynomial, pathConstraints)
%**************************************************************************
% PURPOSE
...
%**************************************************************************
% OUTPUTS
%   - inequality (numeric column), feasible when nonpositive.
%**************************************************************************
% UNITS
%   - Rows retain caller-defined coordinate units.
%**************************************************************************
...
% INPUTS
%   - polynomial (scalar hs3 polynomial struct)
%   - limits (resolved scalar limit struct)
%**************************************************************************
% OUTPUTS
%   - inequality (numeric column), feasible when every value is nonpositive.
%**************************************************************************
% UNITS
%   - Rows retain their derivative's caller-defined units.
%**************************************************************************
coefficientFields = [ ...
...
%% Section 0: Header & Readme
% SYNTAX
%   bernstein = coordinateBernstein(coefficientArray, dimensionIndex)
%**************************************************************************
% PURPOSE
%   - Convert every segment of one coordinate while preserving row order.
%**************************************************************************
% INPUTS
%   - coefficientArray (segment-by-coordinate-by-power numeric)
%   - dimensionIndex (positive integer scalar), selected coordinate.
%**************************************************************************
% OUTPUTS
%   - bernstein (numeric column), coefficient-fast then segment order.
%**************************************************************************
% UNITS
%   - Values retain coefficientArray units.
%**************************************************************************
...
bernstein = hs3Internal.powerToBernstein(powerMatrix);
bernstein = bernstein(:);
end
