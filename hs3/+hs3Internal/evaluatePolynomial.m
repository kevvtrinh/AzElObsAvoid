...
%       hs3Internal.evaluatePolynomial(polynomial, time)
%   [time, position, velocity, acceleration, jerk] = ...
%       hs3Internal.evaluatePolynomial(polynomial, time, segmentIndex)
%**************************************************************************
% PURPOSE
...
%% Section 0: Header & Readme
% SYNTAX
%   value = evaluateRecords(coefficientArray, segmentIndex, localTau)
%**************************************************************************
% PURPOSE
...
%   - segmentIndex (integer column), one segment per sample.
%   - localTau (numeric column), local coordinates in [0, 1].
%**************************************************************************
% OUTPUTS
%   - value (sample-by-coordinate numeric), evaluated records.
%**************************************************************************
% UNITS
%   - Values retain the coefficient array's physical units.
%**************************************************************************
