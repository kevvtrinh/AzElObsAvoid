function [value, gradient, hessian] = integratedSquaredJerk( ...
        decision, isFreeTime, fixedFinalTime, segmentCount, ...
        startTime, dimensionCount)
%% Section 0: Header & Readme
% SYNTAX
%   value = hs3Internal.integratedSquaredJerk(decision, isFreeTime, ...
%       fixedFinalTime, segmentCount, startTime, dimensionCount)
%   [value, gradient] = hs3Internal.integratedSquaredJerk(decision, isFreeTime, ...
%       fixedFinalTime, segmentCount, startTime, dimensionCount)
%   [value, gradient, hessian] = hs3Internal.integratedSquaredJerk( ...
...
if isFreeTime
    error("integratedSquaredJerk:VariableTimeHessian", ...
