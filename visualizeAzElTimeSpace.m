...
%       PolygonCandidateMode="adaptive" retains meaningful corners when a
%       region has at most 2*ExtremeDirectionCount vertices, then bounds
%       denser regions with directional extremes and endpoint tangencies.
%       Explicit "allCorners" and "extreme" modes remain available.
