...
if ~geometryIsStatic && ~seedHasExplicitHold
    [solverSeed.position_deg, dynamicRouteExpansion_deg] = ...
        azElPlannerMethods.corridor.internal.search.expandDynamicRoute( ...
...
routeMotion = azElPlannerMethods.corridor.internal.motion.buildQuinticSpline( ...
    solverSeed.position_deg, initialState, goalState, limits, motionOptions);
straightMotion = azElPlannerMethods.corridor.internal.motion.buildQuinticSpline( ...
...
compactMotion = [];
compactValidation = azElPlannerMethods.corridor.validateTrajectory();
compactPreparation = [];
...
if ~diagnostics.Accepted
    failureValidation = azElPlannerMethods.corridor.validateTrajectory( ...
...
diagnostics.StageTiming = azElPlannerMethods.internal.stageTiming( ...
