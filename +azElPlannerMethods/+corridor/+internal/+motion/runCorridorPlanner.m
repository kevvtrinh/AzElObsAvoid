...
candidate = azElPlannerMethods.corridor.internal.motion.buildQuinticSpline( ...
...
if ~isempty(obstacles)
    ...
    candidate.SeedCorridor = ...
        azElPlannerMethods.corridor.internal.validation.buildSeedCorridor( ...
...
candidate.OptimizerDiagnostics.StageTiming = ...
    azElPlannerMethods.internal.stageTiming(stageTiming, toc(directTimer));
end
