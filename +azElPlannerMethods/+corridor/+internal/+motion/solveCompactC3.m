...
affineModel = struct( ...
    ...
    "JerkBasis", jerkBasis);
fitBasis = positionBasis;
desiredPosition_deg = interp1( ...
    seed.tau, seed.position_deg, normalizedSampleTime, "linear");
...
for trialIndex = 1:8
    [trialMotion, trialControlPoint_deg, lastExitFlag, trialQpCount] = solveDuration( ...
        controlPoint_deg, duration_s, obstacles, initialState, limits, ...
        plannerOptions, interiorIndex, fixedIndex, affineModel);
...
sampleTime_s = initialState.time_s + ...
    duration_s * affineModel.NormalizedSampleTime;
positionBasis = affineModel.PositionBasis;
velocityBasis = affineModel.VelocityBasis / duration_s;
accelerationBasis = affineModel.AccelerationBasis / duration_s^2;
jerkBasis = affineModel.JerkBasis / duration_s^3;
