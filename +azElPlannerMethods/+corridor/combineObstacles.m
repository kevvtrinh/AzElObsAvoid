...
% SYNTAX
%   azElObstacles = azElPlannerMethods.corridor.combineObstacles()
%   azElObstacles = azElPlannerMethods.corridor.combineObstacles([])
%   azElObstacles = azElPlannerMethods.corridor.combineObstacles(obstacle1, obstacle2, ...)
%   azElObstacles = azElPlannerMethods.corridor.combineObstacles(obstacleArray)
%   azElObstacles = azElPlannerMethods.corridor.combineObstacles(nestedObstacleCells)
%**************************************************************************
% PURPOSE
...
% Flatten nested inputs from the pending stack while preserving top-level argument order.
...
% Normalize every flattened obstacle through the same canonical schema gate.
for obstacleIndex = 1:numel(obstacleItems)
    normalizedObstacles{obstacleIndex} = azElPlannerMethods.corridor.normalizeTimeObstacleData( obstacleItems{obstacleIndex});
end
