...
candidate = struct( ...
    ...
    "Identifier", "", ...
    "ConstraintRepresentation", constraintRepresentation, ...
...
inequality = [continuousBoundConstraints(polynomial, limits, options); ...
    azElPlannerMethods.hs3.internal.validation.seedCorridorInequality(polynomial, seedCorridor); ...
    corridorConstraints( ...
...
candidate = struct( ...
    ...
    "SeedCorridor", struct([]), ...
    "SolverDiagnostics", struct( ...
    "Identifier", "", "ConstraintRepresentation", "notBuilt", ...
