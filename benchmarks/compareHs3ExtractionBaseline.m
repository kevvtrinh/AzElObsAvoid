...
for caseIndex = 1:numel(referenceReport.Cases)
    ...
    extracted = hs3Engine.polynomial.createTrajectoryPolynomial( ...
    ...
    [~, position, velocity, acceleration, jerk] = ...
        hs3Engine.polynomial.evaluateTrajectoryPolynomial(extracted, result.time_s);
    ...
    extractedObjective = hs3Engine.polynomial.evaluateIntegratedSquaredJerk( ...
