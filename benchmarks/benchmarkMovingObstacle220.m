...
record = struct( ...
    ...
    'Duration_s',                result.Diagnostics.TrajectoryDuration_s, ...
    'MinimumProvenGap_units', result.Diagnostics.SeparationProof.MinimumSignedGap_units, ...
    'SquaredJerk_units2_s5',     result.Diagnostics.IntegratedSquaredJerk_units2_s5, ...
    'SourceSamples',             numel(source.time_s), ...
    'VerticesPerSnapshot',       220, ...
    'PreparedSamples',           nnz(result.Diagnostics.PreparedObstacles.InternalPreparation.SamplePrepared), ...
    'PreparedIntervals',         nnz(result.Diagnostics.PreparedObstacles.InternalPreparation.IntervalPrepared));
end
