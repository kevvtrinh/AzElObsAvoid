...
for familyIndex=1:4
    for member=1:5
        ...
        goalState=struct('time_s',24,'position_deg',[8 0]);
        limits=struct('maxVelocity_deg_s',[3 3], ...
            'maxAcceleration_deg_s2',[1.5 1.5],'maxJerk_deg_s3',[4 4], ...
            'azimuthInterval_deg',[-10 10],'elevationInterval_deg',[-7 7]);
        if family=="diagonal"
        ...
        for obstacleIndex=1:count
            ...
            items{obstacleIndex}=obstacleAvoidance.obstacles.createObstacle( ...
                "generated "+obstacleIndex,times,az,el,0.12);
        end
