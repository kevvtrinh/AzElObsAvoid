...
%   azElData = makeAzElObstacleData(canonicalObstacle)
%   azElData = makeAzElObstacleData( ...
...
rebuiltObstacles = combineAzElObstacles(obstacleInput);
...
[resolvedOptions, unknownOptionNames] = azElInternal.resolveOptions( ...
